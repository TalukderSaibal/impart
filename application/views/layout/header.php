...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			...
			<span class="align-middle">Impart Heart</span>
        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="<?= base_url('Products') ?>">
							<i class="align-middle" data-feather="book"></i> <span class="align-middle">Product Unit</span>
						</a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="<?= base_url('add-products-attribute') ?>">
							<i class="align-middle" data-feather="book"></i> <span class="align-middle">Product Attribute</span>
						</a>
					</li>
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
                ...
                <img src="<?= base_url('assets/img/avatars/received_972134400668802.jpeg') ?>" class="avatar img-fluid rounded me-1" alt="Saikat Talukder" /> <span class="text-dark">Saikat Talukder</span>
              </a>
